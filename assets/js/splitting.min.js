...
return m(t.target||"[data-splitting]").map(function(i){var n,c,s=i["ðŸŒ"]
return!t.force&&s||(s=i["ðŸŒ"]={el:i},n=e(n=(n=t.by||p(i,"splitting"))&&"true"!=n?n:y),c=function(n,t){for(var e in t)n[e]=t[e]
